...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US", runwayRequirement = 2323),
                    Model("Pilatus PC-12", "Pilatus", capacity = 9, fuelBurn = (9 * 1.2).toInt, speed = 528, range = 3417, price = 1800000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CH", runwayRequirement = 2169),
                    Model("Britten-Norman BN-2 Islander", "Britten-Norman", capacity = 9, fuelBurn = (9 * 1).toInt, speed = 273, range = 1400, price = 2000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "GB", imageUrl = "", runwayRequirement = 1218),
                    Model("Cessna Caravan", "Cessna", capacity = 14, fuelBurn = (14 * 1).toInt, speed = 344, range = 2400, price = 2500000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US", imageUrl = "https://www.norebbo.com/2017/06/cessna-208-grand-caravan-blank-illustration-templates/", runwayRequirement),
                    Model("Britten-Norman MKIII Trislander", "Britten-Norman", capacity = 17, fuelBurn = (17 * 1.3).toInt, speed = 350, range = 1600, price = 4000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "GB", imageUrl = "", runwayRequirement = 1950),
                    Model("Bombardier DHC-6-400", "Bombardier DHC-8", capacity = 19, fuelBurn = (19 * 1.2).toInt, speed = 337, range = 1480, price = 5200000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CA", imageUrl = "", runwayRequirement = 1200),
                    Model("Let L-410NG", "Let L-410", capacity = 19, fuelBurn = (19 * 2.2).toInt, speed = 417, range = 2570, price = 5000000, lifespan = 25 * 52, constructionTime = 0, countryCode = "RU", imageUrl = "", runwayRequirement = ),
                    Model("Let L-410UVP-E20", "Let L-410", capacity = 19, fuelBurn = (19 * 1.9).toInt, speed = 417, range = 1356, price = 4200000, lifespan = 25 * 52, constructionTime = 0, countryCode = "RU", imageUrl = ""),
                      Model("Embraer EMB120 Brasilia", "Embraer ERJ", capacity = 30, fuelBurn = (30 * 1.9).toInt, speed = 552, range = 1750, price = 8000000, lifespan = 30 * 52, constructionTime = 0, countryCode = "BR", imageUrl = "https://www.norebbo.com/2015/02/embraer-120-brasilia-blank-illustration-templates/"),
                      ...
                      Model("Embraer ERJ135", "Embraer ERJ", capacity = 37, fuelBurn = (37 * 2.2).toInt, speed = 850, range = 3241, price = 17500000, lifespan = 30 * 52, constructionTime = 0, countryCode = "BR", imageUrl = "https://www.norebbo.com/2018/05/embraer-erj-135-blank-illustration-templates/"),
                      ...
                      Model("Embraer ERJ140", "Embraer ERJ", capacity = 44, fuelBurn = (44 * 2.5).toInt, speed = 828, range = 2315, price = 15000000, lifespan = 30 * 52, constructionTime = 0, countryCode = "BR", imageUrl = "https://www.norebbo.com/2018/05/embraer-erj-140-blank-illustration-templates/"),
                      Model("Dornier 328JET", "Dornier 328", capacity = 44, fuelBurn = (44 * 1.9).toInt, speed = 740, range = 1665, price = 25000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "DE", imageUrl = "https://www.norebbo.com/2019/01/fairchild-dornier-328jet-illustrations/"),
                      ...
                      Model("Bombardier CRJ100", "Bombardier CRJ", capacity = 50, fuelBurn = (50 * 1.8).toInt, speed = 830, range = 2250, price = 25000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CA", imageUrl = "https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
                      Model("Bombardier CRJ200", "Bombardier CRJ", capacity = 50, fuelBurn = (50 * 1.8).toInt, speed = 830, range = 3150, price = 30000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CA", imageUrl = "https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
                      Model("Embraer ERJ145", "Embraer ERJ", capacity = 50, fuelBurn = (50 * 2.6).toInt, speed = 850, range = 2800, price = 20500000, lifespan = 30 * 52, constructionTime = 0, countryCode = "BR", imageUrl = "https://www.norebbo.com/2018/04/embraer-erj-145-blank-illustration-templates/"),
                      Model("Embraer ERJ145XR", "Embraer ERJ", capacity = 50, fuelBurn = (50 * 2.7).toInt, speed = 850, range = 3700, price = 22000000, lifespan = 30 * 52, constructionTime = 0, countryCode = "BR", imageUrl = "https://www.norebbo.com/2018/04/embraer-erj-145xr-blank-illustration-templates/"),
                      Model("Bombardier DHC-8-300", "Bombardier DHC-8", capacity = 56, fuelBurn = (56 * 2.2).toInt, speed = 450, range = 1711, price = 27000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CA", imageUrl = "https://www.norebbo.com/2018/05/de-havilland-dhc-8-300-blank-illustration-templates/"),
                      Model("Saab 2000", "Saab Regional", capacity = 58, fuelBurn = (58 * 2.5).toInt, speed = 594, range = 2868, price = 25500000, lifespan = 30 * 52, constructionTime = 4, countryCode = "SE", imageUrl = ""),
                      Model("Fokker 50", "Fokker", capacity = 60, fuelBurn = (60 * 2.6).toInt, speed = 471, range = 2400, price = 25000000, lifespan = 30 * 52, constructionTime = 4, countryCode = "NL", imageUrl = ""),
                      Model("Embraer ERJ170", "Embraer ERJ", capacity = 72, fuelBurn = (72 * 3).toInt, speed = 870, range = 3982, price = 31500000, lifespan = 30 * 52, constructionTime = 4, countryCode = "BR", imageUrl = "https://www.norebbo.com/2015/10/embraer-erj-175-templates-with-the-new-style-winglets/"),
                      ...
                      Model("Embraer ERJ175", "Embraer ERJ", capacity = 78, fuelBurn = (78 * 3.2).toInt, speed = 870, range = 4074, price = 35000000, lifespan = 30 * 52, constructionTime = 4, countryCode = "BR"),
                      Model("Fokker 70", "Fokker", capacity = 79, fuelBurn = (79 * 3.4).toInt, speed = 845, range = 2010, price = 32500000, lifespan = 30 * 52, constructionTime = 4, countryCode = "NL", imageUrl = ""),
                      Model("Fokker 70ER", "Fokker", capacity = 79, fuelBurn = (79 * 3.5).toInt, speed = 845, range = 3410, price = 33500000, lifespan = 30 * 52, constructionTime = 4, countryCode = "NL", imageUrl = ""),
                      ...
                      Model("Embraer EMB170-200", "Embraer ERJ", capacity = 88, fuelBurn = (88 * 3).toInt, speed = 871, range = 2200, price = 32000000, lifespan = 30 * 52, constructionTime = 6, countryCode = "BR", imageUrl = "https://www.norebbo.com/2015/10/embraer-erj-175-templates-with-the-new-style-winglets/"),
                      Model("Embraer E175-E2", "Embraer E-Jet E2", capacity = 88, fuelBurn = (88 * 3).toInt, speed = 870, range = 3735, price = 35000000, lifespan = 30 * 52, constructionTime = 6, countryCode = "BR", imageUrl = "https://www.norebbo.com/2019/03/e175-e2-side-view/"),
                      Model("Mitsubishi MRJ-100", "Mitsubishi SpaceJet", capacity = 88, fuelBurn = (88 * 2.3).toInt, speed = 900, range = 3540, price = 68000000, lifespan = 40 * 52, constructionTime = 6, countryCode = "JP", imageUrl = ""),
                      ...
                      Model("Bombardier CRJ900", "Bombardier CRJ", capacity = 90, fuelBurn = (90 * 2.9).toInt, speed = 870, range = 2876, price = 45000000, lifespan = 35 * 52, constructionTime = 8, countryCode = "CA", imageUrl = "https://www.norebbo.com/2016/07/bombardier-canadair-regional-jet-900-blank-illustration-templates/"),
                      Model("Mitsubishi MRJ-90", "Mitsubishi SpaceJet", capacity = 92, fuelBurn = (92 * 2.3).toInt, speed = 900, range = 3770, price = 75000000, lifespan = 40 * 52, constructionTime = 8, countryCode = "JP", imageUrl = ""),
                      Model("BAe 146-200", "BAe 146", capacity = 100, fuelBurn = (100 * 3.2).toInt, speed = 789, range = 3650, price = 39000000, lifespan = 30 * 52, constructionTime = 8, countryCode = "GB", imageUrl = "https://www.norebbo.com/2018/11/british-aerospace-bae-146-200-avro-rj85-blank-illustration-templates/"),
                      ...
                      Model("Bombardier CRJ1000", "Bombardier CRJ", capacity = 104, fuelBurn = (104 * 3).toInt, speed = 870, range = 3004, price = 50000000, lifespan = 35 * 52, constructionTime = 8, countryCode = "CA", imageUrl = "https://www.norebbo.com/2019/06/bombardier-crj-1000-side-view/"),
                      Model("Embraer E190-E2", "Embraer E-Jet E2", capacity = 106, fuelBurn = (106 * 3.5).toInt, speed = 870, range = 5278, price = 45000000, lifespan = 30 * 52, constructionTime = 8, countryCode = "BR", imageUrl = "https://www.norebbo.com/2019/03/e190-e2-blank-side-view/"),
                      Model("Sukhoi Superjet 100", "Sukhoi Superjet", capacity = 108, fuelBurn = (108 * 4.1).toInt, speed = 828, range = 4578, price = 38000000, lifespan = 30 * 52, constructionTime = 8, countryCode = "RU", imageUrl = "https://www.norebbo.com/2016/02/sukhoi-ssj-100-blank-illustration-templates/"),
                      Model("Fokker 100", "Fokker", capacity = 109, fuelBurn = (109 * 3.9).toInt, speed = 845, range = 3170, price = 39000000, lifespan = 30 * 52, constructionTime = 8, countryCode = "NL", imageUrl = "https://www.norebbo.com/2018/07/fokker-100-f-28-0100-blank-illustration-templates/"),
                      Model("Boeing 737-100", "Boeing 737 Classic", capacity = 124, fuelBurn = (124 * 4).toInt, speed = 780, range = 3440, price = 40000000, lifespan = 35 * 52, constructionTime = 8, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/10/boeing-737-100-blank-illustration-templates/"),
                      Model("Airbus A318", "Airbus A320", capacity = 132, fuelBurn = (132 * 3.3).toInt, speed = 829, range = 7800, price = 90000000, lifespan = 35 * 52, constructionTime = 8, countryCode = "NL", imageUrl = "https://www.norebbo.com/2018/01/airbus-a318-blank-illustration-templates-with-pratt-whitney-and-cfm56-engines/"),
                      Model("Bombardier CS100", "Bombardier CS", capacity = 133, fuelBurn = (133 * 3.2).toInt, speed = 828, range = 5741, price = 80000000, lifespan = 35 * 52, constructionTime = 8, countryCode = "CA", imageUrl = "https://www.norebbo.com/2016/02/bombardier-cs100-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737-200", "Boeing 737 Classic", capacity = 136, fuelBurn = (136 * 4.3).toInt, speed = 780, range = 4200, price = 59000000, lifespan = 35 * 52, constructionTime = 12, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/09/boeing-737-200-blank-illustration-templates/"),
                      ...
                      Model("McDonnel Douglas MD-81", "McDonnel Douglas MD", capacity = 150, fuelBurn = (150 * 3.5).toInt, speed = 811, range = 3787, price = 75000000, lifespan = 30 * 52, constructionTime = 16, countryCode = "US",imageUrl = "https://www.norebbo.com/2015/02/mcdonnell-douglas-md-80-blank-illustration-templates/"),
                      ...
                      Model("McDonnel Douglas MD-90", "McDonnel Douglas MD", capacity = 160, fuelBurn = (160 * 3.55).toInt, speed = 811, range = 3787, price = 80000000, lifespan = 30 * 52, constructionTime = 20, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/02/mcdonnell-douglas-md-90-blank-illustration-templates/"),
                      Model("Airbus A319neo", "Airbus A320", capacity = 160, fuelBurn = (160 * 3.5).toInt, speed = 828, range = 6850, price = 100000000, lifespan = 35 * 52, constructionTime = 20, countryCode = "NL", imageUrl = "https://www.norebbo.com/2017/09/airbus-a319-neo-blank-illustration-templates/"),
                      Model("Bombardier CS300", "Bombardier CS", capacity = 160, fuelBurn = (160 * 3.4).toInt, speed = 828, range = 6112, price = 98000000, lifespan = 35 * 52, constructionTime = 20, countryCode = "CA", imageUrl = "https://www.norebbo.com/2016/02/bombardier-cs300-blank-illustration-templates/"),
                      Model("Boeing 737 MAX 7", "Boeing 737 MAX", capacity = 172, fuelBurn = (172 * 3.6).toInt, speed = 830, range = 6500, price = 105000000, lifespan = 35 * 52, constructionTime = 20, countryCode = "US", imageUrl = "https://www.norebbo.com/2016/07/boeing-737-max-7-blank-illustration-templates/"),
                      ...
                      Model("Airbus A320", "Airbus A320", capacity = 180, fuelBurn = (180 * 3.8).toInt, speed = 828, range = 6150, price = 100000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "NL", imageUrl = "https://www.norebbo.com/2013/08/airbus-a320-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737-900", "Boeing 737 Next Generation", capacity = 189, fuelBurn = (189 * 4).toInt, speed = 830, range = 6660, price = 105000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/08/boeing-737-900-blank-illustration-templates/"),
                      Model("Boeing 737 MAX 8", "Boeing 737 MAX", capacity = 189, fuelBurn = (189 * 3.9).toInt, speed = 830, range = 6500, price = 110000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "US", imageUrl = "https://www.norebbo.com/2016/07/boeing-737-max-8-blank-illustration-templates/"),
                      ...
                      Model("Boeing 757-200", "Boeing 757", capacity = 200, fuelBurn = (200 * 4.3).toInt, speed = 854, range = 7250, price = 95000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "US", imageUrl = "https://www.norebbo.com/2015/01/boeing-757-200-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737 MAX 9", "Boeing 737 MAX", capacity = 220, fuelBurn = (220 * 3.9).toInt, speed = 839, range = 6570, price = 124000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/05/boeing-737-9-max-blank-illustration-templates/"),
                      Model("Boeing 737 MAX 10", "Boeing 737 MAX", capacity = 230, fuelBurn = (230 * 3.9).toInt, speed = 830, range = 6500, price = 132000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/01/737-10-max-side-view/"),
                      ...
                      Model("Airbus A321neoXLR", "Airbus A320", capacity = 236, fuelBurn = (236 * 4.4).toInt, speed = 828, range = 8700, price = 133000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2018/10/airbus-a321neo-lr-long-range-blank-illustration-templates/"),
                      ...
                      Model("Airbus A321neoLR", "Airbus A320", capacity = 240, fuelBurn = (240 * 4.15).toInt, speed = 828, range = 7400, price = 132000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2018/10/airbus-a321neo-lr-long-range-blank-illustration-templates/"),
                      Model("Airbus A321neo", "Airbus A320", capacity = 244, fuelBurn = (244 * 4.1).toInt, speed = 828, range = 6850, price = 130000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2017/09/airbus-a321-neo-blank-illustration-templates/"),
                      ...
                      Model("Airbus A300-600", "Airbus A300/A310", capacity = 266, fuelBurn = (266 * 4.6).toInt, speed = 833, range = 7500, price = 110000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2018/11/airbus-a300b4-600r-blank-illustration-templates-with-general-electric-engines/"),
                      ...
                      Model("Boeing 787-9 Dreamliner", "Boeing 787", capacity = 300, fuelBurn = (300 * 4.5).toInt, speed = 903, range = 13950, price = 175000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/04/boeing-787-9-blank-illustration-templates/"),
                      ...
                      Model("Lockheed L-1011-500", "Lockheed L", capacity = 330, fuelBurn = (330 * 5.1).toInt, speed = 972, range = 9899, price = 130000000, lifespan = 30 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2015/03/lockheed-l-1011-500-blank-illustration-templates/"),
                      ...
                      Model("Boeing 767-300ER", "Boeing 767", capacity = 350, fuelBurn = (350 * 4.5).toInt, speed = 913, range = 11093, price = 220000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/07/boeing-767-300-blank-illustration-templates/"),
                      Model("Boeing 787-10 Dreamliner", "Boeing 787", capacity = 360, fuelBurn = (360 * 4.4).toInt, speed = 903, range = 11750, price = 225000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2017/06/boeing-787-10-blank-illustration-templates/"),
                      Model("Airbus A340-500", "Airbus A340", capacity = 375, fuelBurn = (375 * 4.7).toInt, speed = 871, range = 17000, price = 270000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2016/08/airbus-a340-500-blank-illustration-templates/"),
                      Model("Airbus A330-200", "Airbus A330", capacity = 380, fuelBurn = (380 * 4.7).toInt, speed = 871, range = 11300, price = 220000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2016/02/airbus-a330-200-blank-illustration-templates-with-pratt-whitney-engines/"),
                      Model("McDonnel Douglas DC-10-30", "McDonnel Douglas MD", capacity = 380, fuelBurn = (380 * 5.2).toInt, speed = 871, range = 9600, price = 180000000, lifespan = 30 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/11/mcdonnell-douglas-dc-10-30f-md-10-blank-illustration-templates/"),
                      Model("Airbus A350-800", "Airbus A350", capacity = 390, fuelBurn = (390 * 4.3).toInt, speed = 910, range = 15860, price = 280000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2015/06/airbus-a350-800-blank-illustration-templates/"),
                      Model("Boeing 747SP", "Boeing 747", capacity = 400, fuelBurn = (400 * 5).toInt, speed = 1000, range = 15400, price = 235000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/08/boeing-747sp-side-view/"),
                      Model("Lockheed L-1011-1", "Lockheed L", capacity = 400, fuelBurn = (400 * 5.4).toInt, speed = 963, range = 4963, price = 124000000, lifespan = 30 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2015/03/lockheed-l-1011-1-blank-illustration-templates/"),
                      Model("Airbus A330-300", "Airbus A330", capacity = 404, fuelBurn = (404 * 4.7).toInt, speed = 870, range = 13400, price = 235000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2016/02/airbus-a330-300-blank-illustration-templates-with-all-three-engine-options/"),
                      ...
                      Model("Boeing 747-100", "Boeing 747", capacity = 550, fuelBurn = (550 * 5.9).toInt, speed = 895, range = 9800, price = 250000000, lifespan = 35 * 52, constructionTime = 44, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/07/boeing-747-100-side-view/"),
                      Model("Boeing 747-200", "Boeing 747", capacity = 550, fuelBurn = (550 * 5.9).toInt, speed = 895, range = 12700, price = 260000000, lifespan = 35 * 52, constructionTime = 44, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/08/boeing-747-200-side-view/"),
                      Model("Boeing 777-300", "Boeing 777", capacity = 550, fuelBurn = (550 * 5.7).toInt, speed = 945, range = 11121, price = 340000000, lifespan = 35 * 52, constructionTime = 44, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/03/boeing-777-300-blank-illustration-templates/"),
                      Model("Boeing 777-300ER", "Boeing 777", capacity = 550, fuelBurn = (550 * 5.7).toInt, speed = 896, range = 13649, price = 345000000, lifespan = 35 * 52, constructionTime = 44, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/03/boeing-777-300-blank-illustration-templates/"),
                      ...
                      Model("Boeing 747-400ER", "Boeing 747", capacity = 660, fuelBurn = (660 * 6.2).toInt, speed = 913, range = 14200, price = 355000000, lifespan = 35 * 52, constructionTime = 48, countryCode = "US", imageUrl = "https://www.norebbo.com/2013/09/boeing-747-400-blank-illustration-templates/"),
